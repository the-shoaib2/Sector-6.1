...
export const VERIFICATION_CODE_EXPIRY_TIME = "10m"; // 10 minutes
export const ACCOUNT_LOCK_DURATION_TIME = "72h"; // 72 hours
export const VERIFICATION_COOLDOWN_TIME = "15m"; // 15 minutes
